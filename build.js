...
const gist = 'Maxino22/574c8df7ec05864293db9448a4156d56'
const digitalMarketingGist = 'Maxino22/50d6e54d5777d2e19cdf6b7181e6b158'
...
async function buildPDF(html) {
	...
	await browser.close()
	console.log('Saving file...')
	fs.writeFileSync('./dist/my_resume.pdf', pdf)
	console.log('Done')
	return pdf
}
